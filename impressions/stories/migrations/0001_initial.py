    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_include', models.BooleanField(default=False, verbose_name='Use include instead of image')),
                ('include_path', models.CharField(blank=True, default='', max_length=64)),
                ...
                ('fastfacts', models.ManyToManyField(blank=True, to='supporting.FastFact', verbose_name='Fast Facts related to this item')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_num', models.IntegerField(choices=[(0, '0 - Initial Entry'), (1, '1 - In Admin Only'), (2, '2 - Development (Wireframe)'), (3, '3 - Candidate for Publication'), (4, '4 - Published')], default=0)),
                ('caption', models.CharField(blank=True, default='', max_length=255, verbose_name='Image Caption')),
